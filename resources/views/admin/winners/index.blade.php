                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(1, event)" maxLength="2" id="digit1-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(2, event)" maxLength="2" id="digit2-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(3, event)" maxLength="2" id="digit3-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(4, event)" maxLength="2" id="digit4-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(5, event)" maxLength="2" id="digit5-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(6, event)" maxLength="2" id="digit6-input">
                            </div>
                        </div><!-- end col -->

                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit7-input" class="visually-hidden">Digit 7</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(7, event)" maxLength="2" id="digit7-input">
                            </div>
                        </div><!-- end col -->
                        <!-- <div class="col-lg-12">
                            <div class="mb-3">
...
<div id="confirmNumbers" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmNumbersModalLabel">Confirm Winning Numbers</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-confirmNumbersModal"></button>
            </div>
            <form class="numbers-form needs-validation" id="confirmWinnerForm" novalidate autocomplete="off" method="POST">
                <div class="modal-body">
                    <div id="alert-error-msg" class="d-none alert alert-danger py-2"></div>
                    <input type="hidden" id="id-field">
                    <input type="hidden" id="rating-field">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit1-input" class="visually-hidden">Digit 1</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(11, event)" maxLength="2" id="digit11-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit2-input" class="visually-hidden">Digit 2</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(12, event)" maxLength="2" id="digit12-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit3-input" class="visually-hidden">Digit 3</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(13, event)" maxLength="2" id="digit13-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit4-input" class="visually-hidden">Digit 4</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(14, event)" maxLength="2" id="digit14-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit5-input" class="visually-hidden">Digit 5</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(15, event)" maxLength="2" id="digit15-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit6-input" class="visually-hidden">Digit 6</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(16, event)" maxLength="2" id="digit16-input">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="digit7-input" class="visually-hidden">Digit 7</label>
                                <input type="text" class="form-control form-control-lg text-center checkInput" onkeyup="moveToNext(17, event)" maxLength="2" id="digit17-input">
                            </div>
                        </div><!-- end col -->
                        <!-- <div class="col-lg-12">
                            <div class="mb-3">
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-ghost-danger" data-bs-dismiss="modal"><i class="bi bi-x-lg align-baseline me-1"></i> Close</button>
                        <button type="submit" class="btn btn-primary" id="confirm-numbers">Confirm Numbers</button>
                    </div>
                </div>
            </form>
            <!-- <div class="modal-body">
