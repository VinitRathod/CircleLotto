        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="apps-calendar" class="nav-link menu-link"> <i class="ph-calendar"></i> <span data-key="t-calendar">@lang('translation.calendar')</span> </a>
                    </li>

                    <li class="nav-item">
                        <a href="apps-chat" class="nav-link menu-link"> <i class="ph-chats"></i> <span data-key="t-chat">@lang('translation.chat')</span> </a>
                    </li>

                    <li class="nav-item">
                        <a href="apps-email" class="nav-link menu-link"> <i class="ph-envelope"></i> <span data-key="t-email">@lang('translation.email')</span> </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarEcommerce">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="apps-ecommerce-products" class="nav-link" data-key="t-products">@lang('translation.products')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-product-grid" class="nav-link" data-key="t-products-grid">@lang('translation.product-grid')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-product-details" class="nav-link" data-key="t-product-Details">@lang('translation.product-Details')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-add-product" class="nav-link" data-key="t-create-product">@lang('translation.create-product')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-orders" class="nav-link" data-key="t-orders">@lang('translation.orders')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-order-overview" class="nav-link" data-key="t-order-overview">@lang('translation.order-overview')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-customers" class="nav-link" data-key="t-customers">@lang('translation.customers')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-cart" class="nav-link" data-key="t-shopping-cart">@lang('translation.shopping-cart')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-checkout" class="nav-link" data-key="t-checkout">@lang('translation.checkout')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-sellers" class="nav-link" data-key="t-sellers">@lang('translation.sellers')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-seller-overview" class="nav-link" data-key="t-seller-overview">@lang('translation.sellers-overview')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="apps-file-manager" class="nav-link menu-link"> <i class="ph-folder-open"></i> <span data-key="t-file-manager">@lang('translation.filemanager')</span> </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarLearning">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#sidebarCourses" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCourses" data-key="t-courses"> @lang('translation.cources') </a>
                                    <div class="collapse menu-dropdown" id="sidebarCourses">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="apps-learning-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-learning-grid" class="nav-link" data-key="t-grid-view">@lang('translation.grid-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-learning-category" class="nav-link" data-key="t-category">@lang('translation.category')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-learning-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-learning-create" class="nav-link" data-key="t-create-course">@lang('translation.create-course')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="#sidebarStudent" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarStudent" data-key="t-students">@lang('translation.students') </a>
                                    <div class="collapse menu-dropdown" id="sidebarStudent">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="apps-student-subscriptions" class="nav-link" data-key="t-my-subscriptions">@lang('translation.subscriptions')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-student-courses" class="nav-link" data-key="t-my-courses">@lang('translation.mycourses')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="#sidebarInstructors" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarInstructors" data-key="t-instructors"> @lang('translation.instructors')</a>
                                    <div class="collapse menu-dropdown" id="sidebarInstructors">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="apps-instructors-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-instructors-grid" class="nav-link" data-key="t-grid-view">@lang('translation.grid-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-instructors-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-instructors-create" class="nav-link" data-key="t-create-instructors">@lang('translation.create-instructor')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarInvoices">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="apps-invoices-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-invoices-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-invoices-create" class="nav-link" data-key="t-create-invoice">@lang('translation.create-invoice')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarTickets">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="apps-tickets-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-tickets-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="#sidebarRealeEstate" class="nav-link menu-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRealeEstate">
                            <i class="ph-adminings"></i> <span data-key="t-real-estate">@lang('translation.realestate')</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarRealeEstate">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="apps-real-estate-grid" class="nav-link" data-key="t-listing-grid">@lang('translation.listing-grid')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-real-estate-list" class="nav-link" data-key="t-listing-list">@lang('translation.listing-list')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-real-estate-map" class="nav-link" data-key="t-listing-map">@lang('translation.listing-map')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-real-estate-property-overview" class="nav-link" data-key="t-property-overview">@lang('translation.property-overview')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#sidebarAgent" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAgent" data-key="t-agent"> @lang('translation.agent') </a>
                                    <div class="collapse menu-dropdown" id="sidebarAgent">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="apps-real-estate-agent-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-real-estate-agent-grid" class="nav-link" data-key="t-grid-view">@lang('translation.grid-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-real-estate-agent-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="#sidebarAgencies" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAgencies" data-key="t-agencies">@lang('translation.agencies')</a>
                                    <div class="collapse menu-dropdown" id="sidebarAgencies">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="apps-real-estate-agencies-list" class="nav-link" data-key="t-list-view">@lang('translation.list-view')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-real-estate-agencies-overview" class="nav-link" data-key="t-overview">@lang('translation.overview')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-real-estate-add-properties" class="nav-link" data-key="t-add-property">@lang('translation.add-property')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-real-estate-earnings" class="nav-link" data-key="t-earnings">@lang('translation.earnings')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarPages">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="pages-profile-settings" class="nav-link" data-key="t-profile-setting">@lang('translation.settings')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="pages-contacts" class="nav-link" data-key="t-contacts">@lang('translation.contacts')</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="pages-maintenance" class="nav-link" data-key="t-maintenance">@lang('translation.maintenance') </a>
                                </li>
                                <li class="nav-item">
                                    <a href="pages-coming-soon" class="nav-link" data-key="t-coming-soon">@lang('translation.coming-soon') </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="pages-term-conditions" class="nav-link" data-key="t-term-conditions">@lang('translation.term-condition')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#customUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="customUI">
                            <i class="ph-wrench"></i> <span data-key="t-custom-ui">@lang('translation.custom-ui')</span> <span class="badge badge-pill bg-danger" data-key="t-custom">@lang('translation.custom')</span>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#sidebarCharts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCharts">
                            <i class="ph-chart-pie-slice"></i> <span data-key="t-apexcharts">@lang('translation.apexcharts')</span>
                        </a>
